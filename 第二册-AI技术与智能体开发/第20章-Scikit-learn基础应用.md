...
flowchart TD
    ...
    F --> F1["📊 数据量多大?"]
    F1 -->|小数据集<br/>< 1000样本| F2["🧠 逻辑回归<br/>📊 朴素贝叶斯"]
    F1 -->|中等数据集<br/>1k-100k| F3["🌳 决策树<br/>🌲 随机森林"]
    F1 -->|大数据集<br/>> 100k| F4["🚀 支持向量机<br/>🔥 梯度提升"]
    
    G --> G1["📊 特征数量?"]
    G1 -->|特征少<br/>线性关系| G2["📏 线性回归<br/>🏔️ 岭回归"]
    G1 -->|特征多<br/>复杂关系| G3["🌳 决策树回归<br/>🌲 随机森林"]
...
graph TD
    ...
    B --> B1["📊 准确率<br/>(Accuracy)"]
    B --> B2["⏱️ 训练时间<br/>(Speed)"]
    B --> B3["🧠 可解释性<br/>(Interpretability)"]
    B --> B4["📈 扩展性<br/>(Scalability)"]
    
    A --> C["🥊 参赛选手"]
    
    C --> C1["🧠 逻辑回归<br/>⚡ 快速<br/>📊 可解释<br/>📈 线性边界"]
    C --> C2["🌳 决策树<br/>🔍 直观<br/>📊 高解释性<br/>⚠️ 易过拟合"]
    C --> C3["🌲 随机森林<br/>🏆 稳定<br/>📊 特征重要性<br/>⚡ 并行训练"]
    C --> C4["🚀 支持向量机<br/>💪 强力<br/>🎯 高维数据<br/>⏳ 训练较慢"]
    C --> C5["📊 朴素贝叶斯<br/>⚡ 超快<br/>📱 小数据友好<br/>🎯 文本分类强"]
